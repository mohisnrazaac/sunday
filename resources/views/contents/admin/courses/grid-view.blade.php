...
<style>
    ...
    background: white; /* Adjust background color if necessary */
    overflow: auto; /* Add scrolling if needed */
    background-color: black;
	background-image: url(http://192.81.219.28/img/admin/bg_dashboard.jpg);
...
{{-- @foreach($courses as $course)
    ...
    <div class="  container pt-4 ">
        <div class="main mb-5">
            <div class="container homeBorder p-4 mb-5" id="homeBorderContainer">
                <div class="d-flex justify-content-between mb-4">
                    <div class="col">
                        <h1 class="h5 homeHeading"><strong>Course Guide</strong></h1>
                    </div>
                    <div class="col text-end">
                        <i id="maximizeIcon" class="fa-solid fa-maximize iconColor"></i>
    ...
    @endphp
                    ...
                    $limitedParagraph = Str::words($course->coursedescription, 100, '...');
                    @endphp
                    <div class="col-sm-3 col-md-4 col-lg-3 course_card_width">
                        <a href="{{ URL::to('/learn/my/course/')}}/{{$course->courseId}}">
                            <div class="course_{{ $course->theme }}">
                                ...
                                <div class="cc_card_heading text-uppercase">
                                    <h4 class=" pt-1 mb-0"><a href="" class="iconColor mx-1"><strong>{{ $course->courseTitle }}</strong>
                                    </a></h4>
                                </div>
                                ...
                                <div class="px-3  border-top-0 border-bottom-0">
                                    <span class="cc_card_body_text">{{$limitedParagraph}}<br></span>
                                </div>
    ...
    const homeBorderContainer = document.getElementById('homeBorderContainer');
    const header = document.querySelector('header'); // Adjust the selector based on your header tag
    const footer = document.querySelector('footer'); // Adjust the selector based on your footer tag

    maximizeIcon.addEventListener('click', function() {
        // Toggle the fullscreen class on the homeBorderContainer
        homeBorderContainer.classList.toggle('fullscreen');

        // Toggle visibility of header and footer
        if (header) {
