                    ...
                    <div class="card fs-card mt-5" style="padding-right: 0px !important;">
                        <div class="card-body fs-subtitle">
                            <div class="row curriculum" style="margin-top: 0px;margin-bottom: 0px;margin-right: -12px;">
                                <div class="col">
                                    <i class="fa-solid fa-list color-cyan"></i> Curriculum
                                </div>
                                <div class="col text-end">
                                    <button type="button" class="cirr-btn" data-toggle="modal"
                                        data-target="#sectionModal">New Section</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <div class="row mx-0 my-5">
                    <div class="col-12 mb-3">
                        <h6>Select Topic</h6>
                        <select name="selecttopic" class="form-control mb-4 custom-inner-style" id="selecttopic">
                    ...
                    <div class="col-12 mb-3">
                        <input class="form-control w-100 custom-inner-style" name="uploadfile" type="file" id="formFileMultiple" multiple>
                    </div>
                </div>
...
function submitcourse()
{
    ...
    function submitassignment() {
        ...
        formData.append('last_section_id',$('#last_section_id').val());
