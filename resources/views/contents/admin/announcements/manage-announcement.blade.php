...
<div class="container px-4 mt-5 ">
    <div class="main  px-2 ">
        <div class="d-flex justify-content-between mb-4">
            <div class="col">
                <h1 class="homeHeading"><strong>@lang('Manage Announcements')</strong></h1>
            </div>
        </div>
    </div>
    {{-- <h1 class="h5 homeHeading mt-5"><strong>@lang('Manage Announcements')</strong></h1> --}}
