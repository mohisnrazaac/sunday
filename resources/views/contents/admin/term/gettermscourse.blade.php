    ...
    <div class="col-12">
        <div class="card shadow mb-4 border-bottom-primary">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-uppercase">{{ __('Curriculum') }}</h6>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $term->termsTitle  }}</td>
                                <td>
                                    <div class="badge badge-primary">
                                        {{ $term->departmentTitle ?? '' }}
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink" style="">
                                            ...
                                            @can('term.edit')
                                            <x-EditButton itemId="{{ $term->termsId }}" path="term.edit" />
                                            @endcan
                                            @can('term.delete')
                                            <x-DeleteButton itemId="{{ $term->termsId }}" path="term.destroy" />
                                            @endcan

                                            <div class="dropdown-divider"></div>
                                            @can('term.show')
                                            <x-buttons.show itemId="{{ $term->termsId }}" path="term.show" />
                                            @endcan
                                        </div>
                                    </div>
